...
if load_images_pkl:
    ...
    X_train, y_train, height, width = fu.loadImages(filtered_dir, filtered_train_files, original_dir, original_train_files, sub_size=sub_size)
    X_test, y_test, height, width = fu.loadImages(filtered_dir, filtered_test_files, original_dir, original_test_files, sub_size=sub_size)
